...
describe('maps', () => {
  it('MAPS has exactly the ten expected maps in play order', () => {
    const ids = MAPS.map((m) => m.id);
    expect(ids).toEqual(['border_1941', 'moscow_1941', 'village_1942', 'stalingrad_1942', 'steppe_1943', 'korsun_1944', 'forest_1944', 'vistula_1944', 'berlin_1945', 'kremlin_1945']);
  });
...
describe('operation', () => {
  it('OPERATION has 18 battles (multi-day chains replay their authored map) referencing valid maps and team ids', () => {
